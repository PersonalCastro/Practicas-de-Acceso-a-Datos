...
public class TortugaController {
    ...
    public void persistenciaDeDatos(ArrayList<Tortuga> nuevosDatos, int posicion, int tipo_de_uso){
        this.datosPersistentesTortugas.persistenciaDeDatos(nuevosDatos,posicion, tipo_de_uso);
    }
    ...
    public static void printArrayTortugas(ArrayList<Tortuga> tortugasPrint){
        ...
        for(Tortuga tortugaPrint: tortugasPrint){
            ...
            System.out.println("Id referencia: " + tortugaPrint.getCuidador().getId());
