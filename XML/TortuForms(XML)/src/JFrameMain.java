...
public class JFrameMain extends javax.swing.JFrame {
        ...
        if(this.add_tortuga){
            ...
            if(!this.jTextFieldEdad_tortuga.getText().equals("") && 
                ...
                this.listaTortugas.add(new Tortuga(
                        ...
                        Double.valueOf(this.jTextFieldPeso_tortuga.getText()), 
                        auxHiberna,
                ...
                printListTortugas();
                this.controladorDeTortugas.persistenciaDeDatos(this.listaTortugas);
            }
            ...
            if(!this.jListTortugas.isSelectionEmpty()){
                ...
                int selectedIndex = this.jListTortugas.getSelectedIndex();
                this.listaTortugas.get(selectedIndex).setId(Integer.valueOf(this.jTextFieldEdad_tortuga.getText()) );
                this.listaTortugas.get(selectedIndex).setApodo(this.jTextFieldApodo_tortuga.getText());
                this.listaTortugas.get(selectedIndex).setPeso(Double.valueOf(this.jTextFieldPeso_tortuga.getText()));
                this.listaTortugas.get(selectedIndex).setIdReferencia_Cuidador(this.getIdReferenceCuidador_Tortuga(this.jComboBoxIdRefenciaCuidador_Tortuga.getSelectedIndex()));
                if(this.jComboBoxHiberna_tortuga.getSelectedIndex() == 1){
    ...
    private void jButtonGuardar_refugioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardar_refugioActionPerformed
        ...
        if(this.add_refugio){
            ...
            if(!this.jTextFieldNombre_refugio.getText().equals("") && 
                ...
                printListRefugios();
                this.controladorDeRefugios.persistenciaDeDatos(this.listaRefugios);
            ...
            if(!this.jListRefugios.isSelectionEmpty()){
                ...
                printListRefugios();
                this.controladorDeRefugios.persistenciaDeDatos(this.listaRefugios);
                this.controladorDeGruposEspecialistas.persistenciaDeDatos(this.listaGruposEspecialistas);
            }
    ...
    private void jButtonGuardar_grupoEspecialistaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardar_grupoEspecialistaActionPerformed
        ...
        if(this.add_grupoEspecialista){
            ...
            if(!this.jListGrupoEspecialista.isSelectionEmpty()){
                ...
                printListGruposEspecialistas();
                this.controladorDeGruposEspecialistas.persistenciaDeDatos(this.listaGruposEspecialistas);
                this.controladorDeCuidadores.persistenciaDeDatos(this.listaCuidadores);
            }
            ...
            if(!this.jListGrupoEspecialista.isSelectionEmpty()){
                ...
                this.listaGruposEspecialistas.get(selectedIndex).setIdReferencia_refugio(this.getIdReferenceRefugio_GrupoEspecialista(this.jComboBoxIdRefenciaRefugio_grupoEspecialista.getSelectedIndex()));
                if(this.jComboBoxExpedicion_grupoEspecialista.getSelectedIndex() == 1){
    ...
    private void jButtonGuardar_cuidadorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardar_cuidadorActionPerformed
        ...
        if(this.add_cuidador){
            ...
            if(!this.jListCuidadores.isSelectionEmpty()){
                ...
                this.listaCuidadores.get(selectedIndex).setIdReferencia_grupoEspecialista(this.getIdReferenceGrupoEspecialista_Cuidador(this.jComboBoxIdRefenciaGrupoEspecialista_Cuidador.getSelectedIndex()));
                if(this.jComboBoxJefe_cuidador.getSelectedIndex() == 1){
    ...
    private void mostrarDatosRefugioSeleccionado(){
        ...
        if(this.listaRefugios.size() != 0){
            ...
            if(this.listaRefugios.get(selectedIndex).isAbierto()){
    ...
    private void mostrarDatosGrupoEspecialistaSeleccionado(){
        ...
        if(this.listaGruposEspecialistas.size() != 0){
            ...
            this.jComboBoxIdRefenciaRefugio_grupoEspecialista.setSelectedIndex(this.getArrayListPositionWithIdReferenceRefugio_GrupoEspecialista(this.listaGruposEspecialistas.get(selectedIndex).getIdReferencia_refugio()));
            if(this.listaGruposEspecialistas.get(selectedIndex).isExpedicion()){
    ...
    private void mostrarDatosCuidadorSeleccionado(){
        ...
        if(this.listaCuidadores.size() != 0){
            ...
            this.jComboBoxIdRefenciaGrupoEspecialista_Cuidador.setSelectedIndex(this.getArrayListPositionWithIdReferenceGrupoEspecialista_Cuidador(this.listaCuidadores.get(selectedIndex).getIdReferencia_grupoEspecialista()));
            if(this.listaCuidadores.get(selectedIndex).isJefe()){
    ...
    private void mostrarDatosTortugaSeleccionada(){
        ...
        if(this.listaTortugas.size() != 0){
            ...
            this.jComboBoxIdRefenciaCuidador_Tortuga.setSelectedIndex(this.getArrayListPositionWithIdReferenceCuidador_Tortuga(this.listaTortugas.get(selectedIndex).getIdReferencia_Cuidador()));
            if(this.listaTortugas.get(selectedIndex).isHiberna()){
    ...
    private int getIdReferenceRefugio_GrupoEspecialista(int arrayListRefugioPosition){
        
        int id = 0;
        if(arrayListRefugioPosition >= 1){
            id = this.listaRefugios.get(arrayListRefugioPosition - 1).getId();        
        }else{
            id = arrayListRefugioPosition;
        }
        return id;
    }
    
    private int getIdReferenceGrupoEspecialista_Cuidador(int arrayListGrupoEspecialistaPosition){
        
        int id = 0;
        if(arrayListGrupoEspecialistaPosition >= 1){
            id = this.listaGruposEspecialistas.get(arrayListGrupoEspecialistaPosition - 1).getId();
        }else{
            id = arrayListGrupoEspecialistaPosition;
        }
        return id;
    }
    
    private int getIdReferenceCuidador_Tortuga(int arrayListCuidadorPosition){
        
        int id = 0;
        if(arrayListCuidadorPosition >= 1){
            id = this.listaCuidadores.get(arrayListCuidadorPosition - 1).getId();
        }else{
            id = arrayListCuidadorPosition;
        }
        return id;        
    }
    ...
    private void eliminarReferenciasRefugio(int idReference){
        ...
        for(GrupoEspecialista grupoEspecialista: this.listaGruposEspecialistas){
            ...
            if(grupoEspecialista.getIdReferencia_refugio() == idReference){
                grupoEspecialista.setIdReferencia_refugio(0);
            }
        }
    }
    ...
    private void eliminarReferenciasGrupoEspecialista(int idReference){
        ...
        for(Cuidador cuidador: this.listaCuidadores){
            ...
            if(cuidador.getIdReferencia_grupoEspecialista() == idReference){
                cuidador.setIdReferencia_grupoEspecialista(0);
            }
        }
    }
    ...
    private void eliminarReferenciasCuidador(int idReference){
        ...
        for(Tortuga tortuga: this.listaTortugas){
            ...
            if(tortuga.getIdReferencia_Cuidador() == idReference){
                tortuga.setIdReferencia_Cuidador(0);
            }
        }
    }
